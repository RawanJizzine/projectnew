                        ...
                        @foreach ($features_data ?? [] as $index => $data)
                            ...
                            <tr>
                                ...
                                <td> <input type="text" value="{{ $data->title }}" name="title"
                                 ...
                                 <td> <input type="text" value="{{ $data->location }}" name="title"
                                            class="form-control" readonly   ></td>
                                            <td> <input type="text" value="{{ $data->price }}" name="title"
                                                class="form-control" readonly   ></td>
                                ...
                                <td>
                                    <textarea name="" class="form-control" cols="4" rows="6" readonly>{{ $data->sub_description }}</textarea>
                                </td>
                                ...
                                <td>
                                    <a href="#" class="btn btn-sm btn-primary edit-btn" data-toggle="modal"
                                        ...
                                        data-description="{{ $data->description }}"  data-location="{{ $data->location }}" data-subdescription="{{ $data->sub_description}}" data-price="{{ $data->price}}"     >Edit</a>
                    ...
                    <div class="modal-content">
                        ...
                        <form id="editFeatureForm" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <x-input type="text" label="Bundle Cost" id="pricr_edit" name="price_edit"
                                        class="form-control" required="true" />
                                </div>
                                <div class="form-group">
