...
<footer class="content-footer footer bg-footer-theme">
  <div class="{{ $containerFooter }} d-flex justify-content-end ">
    <div class="footer-container d-flex align-items-center justify-content-between py-2 flex-md-row flex-column">
      ...
      , made by <a href="{{ (!empty(config('variables.creatorUrl')) ? config('variables.creatorUrl') : '') }}" target="_blank" class="fw-medium">{{ (!empty(config('variables.creatorName')) ? config('variables.creatorName') : '') }}</a>
      </div>
